...
def normalize_svg(svg: str) -> str:
    """Normalize dynamic terminal IDs and timestamps generated by Rich export to make snapshots deterministic."""
...
async def test_golden_main_recipes_tab() -> None:
    """Golden test for main screen Recipes tab layout and styling."""
